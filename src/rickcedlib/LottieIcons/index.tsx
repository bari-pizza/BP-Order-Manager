...
import AdminShieldIcon from '../../assets/icons/Admin Shield Icon.json';
import CarIcon from '../../assets/icons/Car Icon.json';
import ChartIcon from '../../assets/icons/Chart Icon.json';
import CreditCardIcon from '../../assets/icons/Credit Card Icon.json';
import HomeIcon from '../../assets/icons/Home Icon.json';
import LockIcon from '../../assets/icons/Lock Icon.json';
import MarketPlaceIcon from '../../assets/icons/Marketplace Icon.json';
import MenuIcon from '../../assets/icons/Menu Icon.json';
import SaveIcon from '../../assets/icons/Save Icon.json';
import SearchIcon from '../../assets/icons/Search Icon.json';
import SettingsIcon from '../../assets/icons/Settings Icon.json';
import StaffIcon from '../../assets/icons/Staff Icon.json';
import ThirdPartyIcon from '../../assets/icons/Third Party Icon.json';
import TimeIcon from '../../assets/icons/Time Icon.json';
import UnlockIcon from '../../assets/icons/Unlock Icon.json';
import UploadIcon from '../../assets/icons/Upload Icon.json';
import UserProfileIcon from '../../assets/icons/User Profile Icon.json';
